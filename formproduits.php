...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 justify-content-center g-0">
    <div class="col mb-5">
        <div class="card bg-transparent border-0 ">
            <form class="form-control border border-3 border-success bg-transparent text-center" action="add_produits.php" method="post">
                <div class="m-5">
                    <label class="form-label" class="form-label" for="nom">Nom</label>
                    <input class="form-control" type="text" name="nom" id="nom" autofocus>
                    <br>
                    <label class="form-label" for="effet">Effet</label>
                    <input class="form-control" type="textarea" name="effet" id="effet">
                    <br>
