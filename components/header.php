    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-success p-0 border-black border-bottom">
        <div class="container-fluid d-flex justify-content-between bg-success">
            <div class=" d-flex align-items-center flex-wrap">
                <a class="navbar-brand" href="/medicsong/index.html.php"><img src="/medicsong/assets/img/vinnylmedico.png" alt="Medic'Song" width="80" height="80">
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end pe-5" id="navbarNavDropdown">
                <ul class="navbar-nav fw-bold text-center my-3 fs-6 d-flex justify-content-end">
                    ...
                    <li class="nav-item mx-3 rounded-1">
                        <a class="nav-link active fs-6" href="/medicsong/views/admin.php">ADMINISTRATION</a>
                    </li>
                    <li class="nav-item mx-3 rounded-1">
